...
def run_main():
    ...
    """
    # 初始化路径
    BST_PATH = os.path.abspath('/home/elon/Projects/MFH-main/MNIST/dataset/BSR_bsds500.tgz')
    mnist_dir = os.path.abspath("/home/elon/Projects/MFH-main/MNIST/dataset/MNIST")
    mnistm_dir = os.path.abspath("/home/elon/Projects/MFH-main/MNIST/dataset/MNIST_M")
