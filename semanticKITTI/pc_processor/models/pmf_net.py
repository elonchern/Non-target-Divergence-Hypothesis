...
from pc_processor.models.salsanext import SalsaNext
...
class RGBDecoder(nn.Module):
    ...
    def forward(self, inputs):
        ...
        up_3a = self.up_3a(torch.cat((up_4a, inputs[2]), dim=1)) # [b,273, 32,128]
...
if __name__ == '__main__':
    ...
    train_loader = torch.utils.data.DataLoader(train_pv_loader,
                                                ...
                                                shuffle=True,
                                                drop_last=True)
    input_feature, input_mask, input_label = next(iter(train_loader))
