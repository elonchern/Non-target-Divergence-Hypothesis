...
class NYUDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        return rgb_tensor, depth_tensor, target_hr.T, position, _name + '.png'
...
if __name__ == '__main__':
    ...
    # ------------------------------------------------ #
    data_set = NYUDataset(data_dir,istest=False)
    ...
    # rgb_tensor, depth_tensor,tsdf_hr,target_lr_T, nonempty_T,position,  _filename = data_set[500]
    rgb_tensor, depth_tensor,target_lr_T, position,  _filename = data_set[500]
    print(type(rgb_tensor))
    # print("nonempty = {}".format(nonempty_T.shape))
    ...
    data_set.labeled_voxel2ply(target_lr_T, './2.ply')
    
    # data_set.labeled_voxel2ply(tsdf_hr, './2.ply')
    
    # tsdf = tsdf_hr.reshape(-1)
    # np.savetxt('save_tsdf.txt',tsdf, fmt='%d')
